...
function ProjectEditor() {
    ...
    const handlePosition = (newPosition: any) => {
    ...
    return (
        <>
            <div className="relative flex flex-row h-[calc(100vh-2.5rem)] select-none">
                <Canvas position={position} scale={scale} onPositionChange={handlePosition} onScaleChange={handleScale}>
                    <WebviewArea />
                </Canvas>
                <ResizablePanel>
                ...
                <div className="absolute top-0 w-full">
                    <EditorTopBar onPositionChange={handlePosition} scale={scale} onScaleChange={handleScale} />
                </div>
            </div>
        </>
    );
